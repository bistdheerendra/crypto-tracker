...
export function MlEdgeBadge({ winProbability, className = "" }: MlEdgeBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md border text-xs font-mono-data font-semibold cursor-help shadow-[0_0_12px_rgba(209,255,69,0.25)] bg-gradient-to-r from-accent/25 via-accent/10 to-bull/15 border-accent/45 text-accent ${className}`}
