...
export function GlobeStatic({ className = "" }: { className?: string }) {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="absolute inset-[12%] rounded-full bg-[radial-gradient(circle_at_35%_30%,rgba(209,255,69,0.22),rgba(6,18,37,0.95)_55%,rgba(2,8,23,1))] border border-accent/20 shadow-[0_0_60px_rgba(209,255,69,0.12)]" />
      <svg
        viewBox="0 0 400 400"
      ...
      >
        <defs>
          <radialGradient id="globeGlow" cx="35%" cy="30%" r="65%">
            <stop offset="0%" stopColor="#d1ff45" stopOpacity="0.35" />
            <stop offset="55%" stopColor="#0a1a2e" stopOpacity="0.15" />
            <stop offset="100%" stopColor="#020817" stopOpacity="0" />
          </radialGradient>
        </defs>
        <circle cx="200" cy="200" r="150" fill="url(#globeGlow)" stroke="#d1ff45" strokeOpacity="0.35" strokeWidth="1.2" />
        {/* Latitude lines */}
