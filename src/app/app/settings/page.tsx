...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <p className="text-text-muted text-sm mb-8">Manage your account, Telegram, and alert preferences.</p>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="bg-bg-card border border-white/8 rounded-lg px-4 py-2.5 text-sm text-text-primary focus:outline-none focus:border-accent/40"
            >
